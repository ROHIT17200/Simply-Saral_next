...
const data=[
  ...
  },
  {
    ...
    nonEligible: [],
    requiredDocuments: [
      { name: "Identity Proof", sampleImage: "", portalLink: "pmksy.gov.in", videoLink: "" },
      { name: "Address Proof", sampleImage: "", portalLink: "pmksy.gov.in", videoLink: "" },
      { name: "Land Ownership Proof", sampleImage: "", portalLink: "pmksy.gov.in", videoLink: "" },
      { name: "Photographs", sampleImage: "", portalLink: "pmksy.gov.in", videoLink: "" },
      { name: "Bank Account Details", sampleImage: "", portalLink: "pmksy.gov.in", videoLink: "" }
    ],
    applicationProcess: {
      online: [
