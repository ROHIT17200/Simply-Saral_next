...
const schemes = [
    {
        ...
        requiredDocuments: [
            {
                name: "Aadhaar Card",
                sampleImage: "", // Include path or URL if available
...

    {
        ...
        shortDescription: "Government's flagship integrated scheme for accessible, equitable, high-quality school education (pre-primary to Class 12).",
        portalLink: "https://samagrashiksha.education.gov.in",
        detailedDescription: "SSA merges key educational initiatives: Sarva Shiksha Abhiyan, RMSA, and Teacher Education. It grants infrastructure funds, digital learning tools, and teacher training in government/aided schools. Students from weaker sections receive extra coaching and financial aid.",
        benefits: [
...

    {
        ...
        detailedDescription: "NMMSS offers ₹12,000/year as support for students passing a merit test and meeting income criteria. Awarded by Direct Benefit Transfer and renewed annually on academic performance.",
        benefits: [
        ...
        requiredDocuments: [
            {
                ...
                sampleImage: "",
                portalLink: "https://uidai.gov.in",
                videoLink: "" // No dedicated video link found
            },
            {
...

    {
        ...
        detailedDescription: "Merged under Samagra Shiksha, RMSA focused on secondary school upgrades, teacher training, and scholarships for EWS, SC/ST, and minorities. Infrastructure projects and financial assistance aimed to increase enrollment and learning outcomes at the secondary level.",
        benefits: [
