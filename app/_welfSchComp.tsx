...
export interface WelfareSchemesProps {
  ...
  accentColor?: {
    light: string; // e.g., "blue-600"
    dark: string;  // e.g., "orange-600"
  };
}
...
const getUniqueYears = (schemes: SchemeData[]) => [
  "All Years",
  ...Array.from(new Set(schemes.map((scheme) => scheme.launchedYear.toString()))).sort()
];

// NAVIGATION ITEMS (constant across all pages)
