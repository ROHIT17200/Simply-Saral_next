...
import { GraduationCap, BookOpen, Sprout, Heart } from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className={`bg-gradient-to-br ${colorClasses.bg} ${colorClasses.hover} p-8 relative overflow-hidden transition-all duration-300`}>
                    ...
                    <div className={`w-16 h-16 ${colorClasses.icon} ${isDark ? '' : 'shadow-lg'} rounded-full flex items-center justify-center mb-4 relative z-10 ${isDark ? 'border-2' : ''}`}>
                      <IconComponent className={`${colorClasses.iconColor} w-8 h-8`} strokeWidth={2} />
                    </div>
